...
INSERT INTO INVOICES(INVOICEID, INVOICENUMBER, INVOICEDATE, CLIENT, SUBTOTAL, GST, QST, TOTAL, INVOICESENT, INVOICEPAID)
    VALUES(1, 2017001, "2017-12-30", "Argento Alfonso", 23.99, 1.000, 2.000, 26.99, false, false),
          (2, 2017002, "2017-11-20", "Dr. Miller Richard", 21.00, 1.000, 1.000, 23.00, true, true);