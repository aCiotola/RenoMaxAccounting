...
CREATE TABLE INVOICES(
    ...
    TOTAL DECIMAL(6,2) NOT NULL,
    INVOICESENT BOOLEAN,
    INVOICEPAID VARCHAR(64) NOT NULL
);
...
INSERT INTO EXPENSES(EXPENSEID, DATETIME, SUPPLIER, MAINDESCRIPTION, SUBDESCRIPTION, SUBTOTAL, GST, QST, TOTAL)
    VALUES(1, "2017-12-30", "Costco", "Material", "Plumbing", 23.99, 1.000, 2.000, 26.99);

INSERT INTO INVOICES(INVOICEID, INVOICEDATE, CLIENT, SUBTOTAL, GST, QST, TOTAL, INVOICESENT, INVOICEPAID)
    VALUES(2017001, "2017-12-30", "Argento Alfonso", 23.99, 1.000, 2.000, 26.99, false, "Not Paid -"),
          (2017002, "2017-11-20", "Dr. Miller Richard", 21.00, 1.000, 1.000, 23.00, true, "Paid -");